                        ...
                        <div ref={subtextRef} className="relative w-full min-w-0 pointer-events-auto cursor-move select-none active:scale-95 transition-transform"
                          ...
                          {editingField === "subtext" ? (
                            <input autoFocus value={editableSubtext}
                              ...
                              onBlur={stopEditing} onKeyDown={e => e.key === "Enter" && stopEditing()}
                              onClick={e => e.stopPropagation()} onMouseDown={e => e.stopPropagation()}
                              className="w-full bg-transparent text-white text-[10px] sm:text-[11px] font-black uppercase tracking-[0.2em] italic text-center outline-none border-b border-white/50 pb-1"/>
                          ) : (
                            <p onClick={startEditing("subtext")}
                              className="text-white text-[10px] sm:text-[11px] font-black leading-tight px-4 [text-shadow:_0_4px_12px_rgb(0_0_0_/_95%)] uppercase tracking-[0.2em] opacity-90 italic cursor-text text-center">
                              {editableSubtext}
                            </p>
                          )}
                        </div>
