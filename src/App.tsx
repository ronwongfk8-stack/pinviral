...
export default function App() {
  ...
  // ── Helpers ──────────────────────────────────────────────────────────────────
  const selectAngle = (i: number, angle: ViralAngle, emailOverride?: string) => {
    ...
    if (!hasAutoGenerated) {
      ...
      generateImage({ angleIndex: i, angle, visualPromptOverride: angle.aiImagePrompt || "", emailOverride });
    }
  };
...
{"angles":[{"title":"","seoTitle":"","hook":"","psychology":"","aiImagePrompt":"","headlines":["","","","",""],"subtext":["","",""],"cta":"","pinDescription":"","hashtags":["","","","","","","","","",""],"altText":"","videoPrompts":["","","","",""]}]}`;
      ...
      setStrategy(data);
      selectAngle(0, data.angles[0], activeEmail);
