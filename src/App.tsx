...
export default function App() {
  ...
  // sits near the top, title block (headline+subtext+CTA) stays vertically
  // centered as before (it's shorter now without social proof inside it,
  // so it fits fine at center — no need to push it down). Both still fully
  // draggable from here.
